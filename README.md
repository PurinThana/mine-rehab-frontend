...
| `#/activities/:id` | รายละเอียดกิจกรรมรายรายการ | `pages/ActivityDetailPage.jsx` |
| `#/admin`, `#/admin/<section>` | หน้าจัดการข้อมูล | `admin/AdminApp.jsx` |

การ์ดกิจกรรมทั้งบนหน้าหลักและในหน้ารายการกดเข้าดูรายละเอียดได้ (เป็น `<button>`
จึงโฟกัสด้วยคีย์บอร์ดและกด Enter ได้)
...
**ยังไม่มีหน้า:** `#news-full`, `#files-full`, `#species-full` ยังเป็นลิงก์ค้างในดีไซน์เดิม
